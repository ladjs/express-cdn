    ...
    switch(method) {
      ...
      case 'minify':
        ...
        for (var key in results) {
          ...
          var assetPath  = path.join(options.publicDir, assets[key]);
      ...
      case 'font':
        ...
        fileName  = fileName.split("?")[0].split("#")[0].substr(options.publicDir.length + 1);
...
if (response.statusCode === 'ssss') {
      ...
      switch(type) {
        ...
        case 'text/javascript':
          ...
          return;
        case 'text/css':
          async.map(assets, function(file, callback) {
