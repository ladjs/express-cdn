  ...
  return function(err, response) {
    ...
    if (response.statusCode === 200) {
      ...
      switch(type) {
        ...
        case 'image/png':
        case 'image/gif':
          compile(fileName, assets, S3, options, optipngPath, type, timestamp, finishUpload)(null, null);
          return;
        case 'image/jpg':
        case 'image/jpeg':
        case 'image/pjpeg':
          compile(fileName, assets, S3, options, jpegtranPath, type, timestamp, finishUpload)(null, null);
          return;
        default:
